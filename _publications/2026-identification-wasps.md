...
doi: 
code: 
permalink: /publication/2026-identification-wasps
excerpt: 'This study proposes a deep learning-based framework for the automated identification of Ichneumonoidea wasps using a YOLO-based architecture integrated with High-Resolution Class Activation Mapping (HiResCAM) to enhance interpretability.'
date: 2026-03-18
venue: 'Paper submitted to Elsevier Applied Soft Computing'
paperurl: 'https://arxiv.org/abs/2603.16351'
bibtexurl: ''
citation: ''
---
